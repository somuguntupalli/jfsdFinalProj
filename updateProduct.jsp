				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="woodentoy"
								<%="woodentoy".equalsIgnoreCase(ptype) ? "selected" : ""%>>WOODENTOY</option>
							<option value="tribalpainting"
								<%="tribalpainting".equalsIgnoreCase(ptype) ? "selected" : ""%>>TRIBALPAINTING</option>
							<option value="clothes"
								<%="clothes".equalsIgnoreCase(ptype) ? "selected" : ""%>>CLOTHES</option>
							<option value="tribalcraft"
								<%="tribalcraft".equalsIgnoreCase(ptype) ? "selected" : ""%>>TRIBALCRAFT</option>
							<option value="musicalinstrument"
								<%="musicalinstrument".equalsIgnoreCase(ptype) ? "selected" : ""%>>MUSICALINSTRUMENT</option>
							<option value="householditem"
								<%="householditem".equalsIgnoreCase(ptype) ? "selected" : ""%>>HOUSEHOLDITEM</option>
							<option value="other"
